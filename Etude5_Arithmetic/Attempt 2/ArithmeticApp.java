...
public class ArithmeticApp {
    ...
    public static ArithTree<Node> problemTree = new ArithTree<Node>();
...
/*
            if (option == 'N'){
                problemTree = new ArithTree<NormalNode>();
            }else if (option =='L'){
                problemTree = new ArithTree<LTRNode>();

            }else{
                System.err.println("Option error wrong letter input");
                System.exit(0);
            }
*/
